...
class launcher():
    def __init__(self):
        ...
        self.path_rf2o = rospy.get_param('path_rf2o', '')
        self.launch_rf2o = Launch(self.path_rf2o)
        rospy.Subscriber('/odom', Odometry, self.callBack_rf2o)
        self.is_rf2o = 0
        self.count_node += 1
    ...
    def run(self):
        while not rospy.is_shutdown():
            ...
            # -- rf20
                ...
                self.notification = 'launch_rf2o'
                self.launch_rf2o.start()
                # self.step = 5
                if (self.is_rf2o == 1):
                    self.step += 1
                    time.sleep(self.timeWait)
