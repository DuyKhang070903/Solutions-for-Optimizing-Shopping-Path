...
private:
        ...
        robot_navigation::GARequest::Response &res)
    {
        ...
        {
            std::string filename = "/home/jetson/thesisAutonomous_ws/src/robot_navigation/AStarResult/" + gaResult[i-1] + "To" + gaResult[i] + ".json";
    ...
    void publishPathAndGoal(void) {
        std::string filePath = "/home/jetson/thesisAutonomous_ws/src/robot_navigation/ProductPose/" + gaResult[gaResultIndex] + ".json";
...
public:
    ...
    void loadPathFile(void)
    {
        ...
        std::string folderPath = "/home/jetson/thesisAutonomous_ws/src/robot_navigation/ProductPose";
        try {
    ...
    void createJsonFile(void) {
        ...
        for (uint32_t i = 0; i < fileJsonData.size(); i++) {
            for (uint32_t j = 0; j < fileJsonData.size(); j++) {
                ...
                // Specify the file path where you want to save the JSON file
                std::filesystem::path filePath = "/home/jetson/thesisAutonomous_ws/src/robot_navigation/AStarResult/";
    ...
    visualization_msgs::Marker createWaypointsMarker(void) {
        ...
        for (const auto &productName : gaResult) {
            std::string filePath = "/home/jetson/thesisAutonomous_ws/src/robot_navigation/ProductPose/" + productName + ".json";
...
//            if (isInPath) continue;
            ...
            std::string filePath = "/home/jetson/thesisAutonomous_ws/src/robot_navigation/ProductPoseReal/" + goodName + ".json";
