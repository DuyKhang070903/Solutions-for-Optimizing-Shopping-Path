...
PathPlanningGA::PathPlanningGA(void)
        : populationSize(250), generations(2500), mutationRate(0.01), crossoverRate(0.8), stopGA(false) {
...
double PathPlanningGA::getCostFromJson(const std::string& from, const std::string& to) {
    std::string filename = "/home/jetson/thesisAutonomous_ws/src/robot_navigation/AStarResult/" + from + "To" + to + ".json";
    std::string altFilename = "/home/jetson/thesisAutonomous_ws/src/robot_navigation/AStarResult/" + to + "To" + from + ".json";
...
bool PathPlanningGA::handleGARequest(robot_navigation::GARequest::Request &req,
    ...
    std::vector<Good> allGoods = readGoodsFromFiles("/home/jetson/thesisAutonomous_ws/src/robot_navigation/ProductPoseReal");
...
ROS_INFO_STREAM("Measure time for GA+Kmeans: " << duration.count());
