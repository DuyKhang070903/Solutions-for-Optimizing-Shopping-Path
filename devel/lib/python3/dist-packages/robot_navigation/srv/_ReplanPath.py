...
"""autogenerated by genpy from robot_navigation/ReplanPathRequest.msg. Do not edit."""
import codecs
import sys
...
class ReplanPathRequest(genpy.Message):
  _md5sum = "ccb37d0f7296f141cce9c011c27d07ac"
  _type = "robot_navigation/ReplanPathRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ReplanPathRequest, self).__init__(*args, **kwds)
...
def _get_struct_7d3I():
    ...
    return _struct_7d3I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robot_navigation/ReplanPathResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ReplanPathResponse(genpy.Message):
  _md5sum = "10fd4e7ff4ebbea1e9b38d66a6c58f35"
  _type = "robot_navigation/ReplanPathResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """nav_msgs/Path planned_path
...
float32 data"""
  __slots__ = ['planned_path','cost']
  _slot_types = ['nav_msgs/Path','std_msgs/Float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ReplanPathResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.planned_path is None:
        self.planned_path = nav_msgs.msg.Path()
      if self.cost is None:
        self.cost = std_msgs.msg.Float32()
    else:
      self.planned_path = nav_msgs.msg.Path()
      self.cost = std_msgs.msg.Float32()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.planned_path.header.seq, _x.planned_path.header.stamp.secs, _x.planned_path.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.planned_path.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.planned_path.poses:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.planned_path.header.seq, _x.planned_path.header.stamp.secs, _x.planned_path.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      for i in range(0, length):
        ...
        self.planned_path.poses.append(val1)
      start = end
      end += 4
      (self.cost.data,) = _get_struct_f().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
def _get_struct_f():
    ...
    return _struct_f
class ReplanPath(object):
  _type          = 'robot_navigation/ReplanPath'
  _md5sum = '570ec26491df9ed08af93654de135263'
  _request_class  = ReplanPathRequest
  _response_class = ReplanPathResponse
